...
//        locationDAO.save(loc1);
        ...
        Location loc1ById = locationDAO.getById(UUID.fromString("24b83177-09ad-403a-91a2-4384fd86d712"));
        ...
        Evento ev1byDatabase = eventoDAO.getById(UUID.fromString("1e53ccc0-8ed3-4228-a8ef-acf80b8f118e"));
        System.out.println(ev1byDatabase);
//
//        eventoDAO.save(ev1);
//        eventoDAO.save(ev2);
//        eventoDAO.save(ev3);
